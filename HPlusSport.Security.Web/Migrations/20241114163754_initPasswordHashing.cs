...
{
    /// <inheritdoc />
    public partial class initPasswordHashing : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "adam@example.com", "0sKswgdhhCAr4frGprYywD/2Mos=", "", "JiBQVaf3IqXKN3zbKyUmVSCwm1Clq4y+DJeFJZRlagI=" },
                    { 2, "barbara@example.com", "83NgMJJsoIQpPUFsyrJ/7vkQcAs=", "", "KsHK+EyEyKKxlJEW4NCj00EuoaYBcdZ4t+oflW9dxUY=" }
                });
